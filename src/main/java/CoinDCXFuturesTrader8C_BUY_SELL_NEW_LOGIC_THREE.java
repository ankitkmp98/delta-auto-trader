...
public class CoinDCXFuturesTrader8C_BUY_SELL_NEW_LOGIC_THREE {
   ...
   private static final String API_SECRET = System.getenv("DELTA_API_SECRET");
    ...
    private static final double MAX_MARGIN = 999.0;
    private static final int MAX_ORDER_STATUS_CHECKS = 9;
    private static final int ORDER_CHECK_DELAY_MS = 999;
    private static final long TICK_SIZE_CACHE_TTL_MS = 3600000; // 1 hour cache
private static final int LOOKBACK_PERIOD = 09; // Minutes for trend analysis (changed from hours)
