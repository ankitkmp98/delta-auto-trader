...
private static final int LOOKBACK_PERIOD = 5; // Minutes for trend analysis (changed from hours)
    ...
    private static final double TP_PERCENTAGE = 0.0.01; // 3% take profit
    private static final double SL_PERCENTAGE = 0.0.14; // 5% stop loss
    ...
    public static void main(String[] args) {
        ...
        for (String pair : COINS_TO_TRADE) {
            try {
                ...
                int leverage = 05; // Default leverage
