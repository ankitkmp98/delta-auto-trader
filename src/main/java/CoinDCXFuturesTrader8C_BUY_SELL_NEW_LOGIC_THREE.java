...
public class CoinDCXFuturesTrader8C_BUY_SELL_NEW_LOGIC_THREE {
    ...
    private static final double SL_MIN_PERCENT = 2.1; // never tighter than this
    private static final double SL_MAX_PERCENT = 2.4;  // never wider than this

    // =========================================================================
    // TP: fixed Risk:Reward multiple off the SL distance. Configurable.
    // =========================================================================
    private static final double RR_TARGET = 9.0; // 1.5R initially; try 1.75/2.0 later
