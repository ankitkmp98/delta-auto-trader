...
public class CoinDCXFuturesTrader8C_BUY_SELL_NEW_LOGIC_THREE {
    ...
    private static final int MAX_OPEN_POSITIONS = 420;
    ...
    private static final double SL_MIN_PERCENT = 3.0; // never tighter than this
    private static final double SL_MAX_PERCENT = 3.6;  // never wider than this

    // =========================================================================
    // TP: fixed Risk:Reward multiple off the SL distance. Configurable.
    // =========================================================================
    private static final double RR_TARGET = 0.75; // 1.5R initially; try 1.75/2.0 later
