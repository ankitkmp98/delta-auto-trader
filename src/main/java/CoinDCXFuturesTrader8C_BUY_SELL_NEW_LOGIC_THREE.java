...
public class CoinDCXFuturesTrader8C_BUY_SELL_NEW_LOGIC_THREE {
    ...
    private static final double MAX_MARGIN = 1800.0;
    ...
    private static final double TP_PERCENTAGE = 0.0099; // 3% take profit
    private static final double SL_PERCENTAGE = 0.072; // 5% stop loss
