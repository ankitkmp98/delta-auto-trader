...
public class CoinDCXFuturesTrader8C_BUY_SELL_NEW_LOGIC_THREE {
    ...
    private static final double SL_MIN_PERCENT  = 10.0;  // CHANGED: was 3.0 — noise floor
    private static final double SL_MAX_PERCENT  = 12.0;  // CHANGED: was 4.0 — structure wider than this -> trade skipped
    private static final double SL_HARD_PERCENT_CAP  = 14.0;  // CHANGED: was 6.0 — fallback ONLY (ATR unavailable); 6% @12x = 72% of margin
