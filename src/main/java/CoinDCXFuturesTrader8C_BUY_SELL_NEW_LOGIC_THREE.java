...
public class CoinDCXFuturesTrader8C_BUY_SELL_NEW_LOGIC_THREE {
    ...
    private static final int LOOKBACK_PERIOD = 3; // Minutes for trend analysis (changed from hours)
    private static final double TREND_THRESHOLD = 0.027; // 2% change threshold for trend
    private static final double TP_PERCENTAGE = 0.021; // 3% take profit
    private static final double SL_PERCENTAGE = 0.050; // 5% stop loss
