...
public class CoinDCXFuturesTrader8C_BUY_SELL_NEW_LOGIC_THREE {
    ...
    private static final double RR_STRONG = 2.2;  // ADX >= 40  (was 1.5)
    private static final double RR_MEDIUM = 2.0;  // ADX >= 30  (was 1.4)
    private static final double RR_WEAK   = 1.8;  // ADX < 30   (was 1.3)
    ...
    private static final String[] COIN_SYMBOLS = {
        ...
        "BCH", "LINK", "AVAX", "FIL", "OP", "NEAR", "TRX", "ARB", "WLD",
        "FET", "ETC", "AAVE", "WIF", "INJ", "TIA", "LTC", "ORDI", "TON",
        "HBAR", "IMX", "ATOM", "RUNE", "UNI", "ICP", "SEI", "PENDLE", "1000SHIB",
        "1000BONK", "JUP"
    };
